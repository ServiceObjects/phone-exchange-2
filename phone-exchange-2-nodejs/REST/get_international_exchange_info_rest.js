...
/**
 * <summary>
 * Constructs a full URL for the GetInternationalExchangeInfo API endpoint by combining the base URL
...
const buildUrl = (params, baseUrl) =>
    `${baseUrl}GetInternationalExchangeInfo?${querystring.stringify(params)}`;
...
/**
 * <summary>
 * Provides functionality to call the ServiceObjects Phone Exchange (PE2) API's GetInternationalExchangeInfo endpoint,
 ...
 * </summary>
 */
const GetInternationalExchangeInfoClient = {
    /**
     * <summary>
     * Asynchronously invokes the GetInternationalExchangeInfo API endpoint, attempting the primary endpoint
     ...
     */
    async invokeAsync(PhoneNumber, Country, LicenseKey, isLive = true, timeoutSeconds = 15) {
        const params = {
            PhoneNumber,
            Country,
            LicenseKey
    ...
    /**
     * <summary>
     * Synchronously invokes the GetInternationalExchangeInfo API endpoint by wrapping the async call
     ...
     * @param {boolean} isLive - Value to determine whether to use the live or trial servers.
     * @param {number} timeoutSeconds - Timeout, in seconds, for the call to the service.
     * @returns {PE2Response} - A PE2Response object with international phone exchange details or an error.
     */
    invoke(PhoneNumber, Country, LicenseKey, isLive = true, timeoutSeconds = 15) {
        return (async () => await this.invokeAsync(
            PhoneNumber, Country, LicenseKey, isLive, timeoutSeconds
        ))();
    }
};

export { GetInternationalExchangeInfoClient, PE2Response };